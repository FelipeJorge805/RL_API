...
def terraria_instance(agent_id, base_path=r"/home/felipe/.steam/steam/steamapps/common/Tmods", base_folder_name="tModLoader", server_ip="127.0.0.1", server_port=7777, agent_base_port=5000):
    agent_folder = os.path.join(base_path, f"{base_folder_name}{agent_id+1}")  # Folder names: tModLoader1, tModLoader2, etc.
    exe_path = os.path.join(agent_folder, "start-tModLoader.sh")
