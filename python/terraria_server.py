...
def launch_server():
    server_folder = r"/home/felipe/.steam/steam/steamapps/common/tModLoader"  # <-- Change this to your server folder
    batch_path = os.path.join(server_folder, "start-tModLoaderServer.sh")  # <-- THIS instead of tModLoader.exe
